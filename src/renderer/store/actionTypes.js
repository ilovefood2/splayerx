...
export const AudioTranslate = {
  ...
  AUDIO_TRANSLATE_RELOAD_BALANCE: 'AUDIO_TRANSLATE_RELOAD_BALANCE',
};
...
export const Browsing = {
  ...
  UPDATE_IS_HOME_PAGE: 'UPDATE_IS_HOME_PAGE',
  ...
  UPDATE_BOOKMARK_SELECTED_INDEX: 'UPDATE_BOOKMARK_SELECTED_INDEX',
  UPDATE_GETTING_TEMPORARY_VIEW_INFO: 'UPDATE_GETTING_TEMPORARY_VIEW_INFO',
};
...
export const UserInfo = {
  ...
  UPDATE_POINTS_LIST: 'UPDATE_POINTS_LIST',
  UPDATE_PAY_STATUS: 'UPDATE_PAY_STATUS',
...
export const Editor = {
  TRY_ENTER_PROFESSIONAL: 'TRY_ENTER_PROFESSIONAL',
  ...
  UPDATE_EDIT_HISTORY_LEN: 'UPDATE_EDIT_HISTORY_LEN',
  ...
  LOAD_REFERENCE_SUBTITLE: 'LOAD_REFERENCE_SUBTITLE', // load参考字幕
  ...
  SUBTITLE_EDITOR_UNDO: 'SUBTITLE_EDITOR_UNDO',
  SUBTITLE_EDITOR_REDO: 'SUBTITLE_EDITOR_REDO',
  SUBTITLE_MODIFIED: 'SUBTITLE_MODIFIED',
  SUBTITLE_CONVERT_TO_MODIFIED: 'SUBTITLE_CONVERT_TO_MODIFIED',
  SUBTITLE_EDITOR_SAVE: 'SUBTITLE_EDITOR_SAVE',
  SUBTITLE_EDITOR_EXPORT: 'SUBTITLE_EDITOR_EXPORT',
  SUBTITLE_EDITOR_LOAD_LOCAL_SUBTITLE: 'SUBTITLE_EDITOR_LOAD_LOCAL_SUBTITLE',
};
